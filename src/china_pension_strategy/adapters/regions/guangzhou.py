"""Guangzhou flexible-employment region adapter.

Builds the canonical policy queries for Guangzhou flexible-employment analysis
...
JURISDICTION = "CN-4401"
NATIONAL_JURISDICTION = "CN"
POPULATION_ENTERPRISE = "enterprise participants"
POPULATION_FLEX = "guangzhou flexible employment participants"
POPULATION_SUBSIDY = "guangzhou employment-difficulty flexible employment participants"
...
class GuangzhouRegionAdapter:
    """Canonical Guangzhou flexible-employment queries and fact mapping."""
    ...
    def policy_queries(
        ...
        *,
        ...
        """Return the canonical query set for Guangzhou flexible employment."""
        common: dict[str, Any] = {
