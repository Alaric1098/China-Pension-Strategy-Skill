...
### 历史包与到期门禁区分（计划 2026-08-14-historical-flag.md）
...
### 校验器误判修复 + 四项遗留（计划 2026-08-14-verifier-and-leftovers.md）
...
- 依据已批准计划 `docs/plans/2026-08-14-task1b-gd-medical-unemployment.md`（Step 0 只读调研 + Step 1 落包）。
...
- 依据已批准计划 `docs/plans/2026-08-14-rates-payment-months.md` 步骤 A；来源全部为可核验 gov.cn 文本。
