"""Chongqing flexible-employment region adapter.

Builds the canonical policy queries for Chongqing flexible-employment analysis
(municipality: provincial and municipal layers coincide).
...
POPULATION_FLEX = "chongqing flexible employment participants"
POPULATION_ENTERPRISE = "enterprise participants"
POPULATION_SUBSIDY = "chongqing employment-difficulty flexible employment participants"
...
class ChongqingRegionAdapter:
    """Canonical Chongqing flexible-employment queries and fact mapping."""
    ...
    def policy_queries(
        ...
        *,
        ...
        """Return the canonical query set for Chongqing flexible employment."""
        common = {
