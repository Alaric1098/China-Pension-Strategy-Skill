"""Chengdu flexible-employment region adapter.

Builds the canonical policy queries for Chengdu flexible-employment analysis
using the Sichuan provincial layer for contribution rules and
the Chengdu municipal layer for subsidy rules.
...
JURISDICTION = "CN-5101"
NATIONAL_JURISDICTION = "CN"
PROVINCE_JURISDICTION = "CN-51"
POPULATION_FLEX = "sichuan flexible employment participants"
POPULATION_ENTERPRISE = "enterprise participants"
POPULATION_SUBSIDY = "chengdu employment-difficulty flexible employment participants"
...
class ChengduRegionAdapter:
    """Canonical Chengdu flexible-employment queries and fact mapping."""
    ...
    def policy_queries(
        ...
        *,
        ...
        """Return the canonical query set for Chengdu flexible employment."""
        common = {
