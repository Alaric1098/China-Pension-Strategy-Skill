"""Shanghai flexible-employment region adapter.

Builds the canonical policy queries for Shanghai flexible-employment analysis
...
POPULATION_FLEX = "shanghai flexible employment participants"
POPULATION_SUBSIDY = "shanghai employment-difficulty flexible employment participants"
...
class ShanghaiRegionAdapter:
    """Canonical Shanghai flexible-employment queries and fact mapping."""
    ...
    def policy_queries(
        ...
        *,
        ...
        """Return the canonical query set for Shanghai flexible employment."""
        common = {
