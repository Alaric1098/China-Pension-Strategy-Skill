"""Nanjing flexible-employment region adapter.

Builds the canonical policy queries for Nanjing flexible-employment analysis
using the Jiangsu provincial layer for contribution rules and
the Nanjing municipal layer for subsidy rules.
...
JURISDICTION = "CN-3201"
NATIONAL_JURISDICTION = "CN"
PROVINCE_JURISDICTION = "CN-32"
POPULATION_FLEX = "jiangsu flexible employment participants"
POPULATION_ENTERPRISE = "enterprise participants"
POPULATION_SUBSIDY = "nanjing employment-difficulty flexible employment participants"
...
class NanjingRegionAdapter:
    """Canonical Nanjing flexible-employment queries and fact mapping."""
    ...
    def policy_queries(
        ...
        *,
        ...
        """Return the canonical query set for Nanjing flexible employment."""
        common = {
