"""Wuhan flexible-employment region adapter.

Builds the canonical policy queries for Wuhan flexible-employment analysis
using the Hubei provincial layer for contribution rules and
the Wuhan municipal layer for subsidy rules.
...
JURISDICTION = "CN-4201"
NATIONAL_JURISDICTION = "CN"
PROVINCE_JURISDICTION = "CN-42"
POPULATION_FLEX = "hubei flexible employment participants"
POPULATION_ENTERPRISE = "enterprise participants"
POPULATION_SUBSIDY = "wuhan employment-difficulty flexible employment participants"
...
class WuhanRegionAdapter:
    """Canonical Wuhan flexible-employment queries and fact mapping."""
    ...
    def policy_queries(
        ...
        *,
        ...
        """Return the canonical query set for Wuhan flexible employment."""
        common = {
