"""Tianjin flexible-employment region adapter.

Builds the canonical policy queries for Tianjin flexible-employment analysis
...
POPULATION_FLEX = "tianjin flexible employment participants"
POPULATION_ENTERPRISE = "enterprise participants"
POPULATION_SUBSIDY = "tianjin employment-difficulty flexible employment participants"
...
class TianjinRegionAdapter:
    """Canonical Tianjin flexible-employment queries and fact mapping."""
    ...
    def policy_queries(
        ...
        *,
        ...
        """Return the canonical query set for Tianjin flexible employment."""
        common = {
